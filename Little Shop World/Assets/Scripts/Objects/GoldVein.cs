        ...
        if(canTakeDamage)
        {
            if(hp > 0)
            {
                ...
                if (randomCoins == 0)
                {
                    ...
                    coin1.GetComponent<Rigidbody2D>().AddForce(-transform.up * 5, ForceMode2D.Impulse);
                }
                else if (randomCoins == 1)
                {
                    ...
                    coin2.GetComponent<Rigidbody2D>().AddForce(transform.up * 5, ForceMode2D.Impulse);
                }
                else if (randomCoins == 2)
                {
                    ...
                    coin3.GetComponent<Rigidbody2D>().AddForce(-transform.right * 5, ForceMode2D.Impulse);
                }
